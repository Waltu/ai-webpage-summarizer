...
const getDocumentText = async (url) => {
...
const createCompletion = async (prompt, options = {}) => {
    const mergedOptions = {
        ...getDefaults,
        ...options,
        model: MODEL
...
export const getSummaryByURL = async (url, options) => {
...
//# sourceMappingURL=summerize-url.js.map